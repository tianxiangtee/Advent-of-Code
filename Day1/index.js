...
// Use a regular expression to match sequences of letters and numbers
const data = text.match(/[a-zA-Z0-9]+/g);

let sum = 0;

if (data) {
  data.forEach((sequence) => {
    const numbers = sequence.match(/\d+/g);
    
    if (numbers) {
      const firstDigit = numbers[0][0];
      const lastDigit = numbers[numbers.length - 1][0];
